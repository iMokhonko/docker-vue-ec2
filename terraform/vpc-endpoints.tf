...
resource "aws_security_group" "chat_vpc_endpoint_sg" {
  name        = "chat-vpc-endpoint-sg"
...
#   to_port           = 0
#   protocol          = "-1"
#   security_group_id = aws_security_group.chat_vpc_endpoint_sg.id
...
resource "aws_vpc_endpoint" "ecr_api" {
  ...
  security_group_ids = [aws_security_group.chat_vpc_endpoint_sg.id]
